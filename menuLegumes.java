...
public class menuLegumes extends Menu {

	public menuLegumes(String tipoMenu) {
		super(tipoMenu);
	}
	...
	public void aspectoComida() {
		...
		do {
			...
			System.out.println("Sobre o aspecto visual dos legumes servidos na escola: Que nota você daria?" );
	...
	public void frequenciaComida() {
		...
		int numero; 
			do {		
				System.out.println("Os legumes vem sendo servidos com frequência?");
	...
	public void comerTudo() {
		...
		int numero; 
			do {		
				System.out.println("Você costuma comer todos os legumes? ");
				System.out.println("1. Sim" + "\n2. Não");
				Scanner leia = new Scanner(System.in);
				System.out.println("Digite a opção escolhida: ");
				 numero = leia.nextInt();
